<%@page import="com.poke.domain.ReactVO"%>
...
<body>
	<%
		...
		ArrayList<ReactVO> list = (ArrayList)request.getAttribute("list");
	%>
	...
	<div id="page">
		...
		<div class = "plant_problem_container">
			<div class="title"><h1>Plant problem</h1></div>
		<div class="plant_problem">
		<div class="p_container">
			<%
				...
				int z = 0;
				int a = 1;
				for(ReactVO result : list){
					if(i==0 || i ==2){
						out.print("<div class='card-column column-"+y+"'>");
						y = 1;
					}
					if(z<4){
						out.print("<div class='card card-color-"+z+"'>");	
					}else if(a<4){
						out.print("<div class='card card-color-"+a+"'>");	
						a+=2;
					}else {
						out.print("<div class='card card-color-"+i+"'>");	
					}
					
					out.print("<div class='border'></div>");
					out.print("<img src='images/react"+i+".jpg' />");
					out.print("<h1>"+result.getCategorize()+"</h1>");
					out.print("</div>");
					if(i==1){
						out.print("</div>");
					}
