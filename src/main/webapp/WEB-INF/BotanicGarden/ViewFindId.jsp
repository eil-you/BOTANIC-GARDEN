...
<html>
	...
	<body>
	<%
		UserInfoVO vo =  (UserInfoVO)request.getAttribute("email");
	%>
				...
				<div class="col-md-6 col-xs-6 text-center menu-1">
					<ul>
						<li class="has-dropdown">
							<a href="plantCalendarView.do">식물등록</a>
						</li>
						<li class="has-dropdown">
	...
	<div class="join">
		<div class="container">
		  <div class="form_txtInput">
			...
			<div class="join_form">
			<form action="viewLogin.do" method="post">
			  <table>
				  <tr id="findidtable">
					  <td align="right" style="font-size : 10pt; width:30%">당신의 아이디는</td>
					  <td align="center" style="color:red; font-size: 20pt; width:60%"><%=vo.getId() %></td>
					  <td align="right" style="font-size : 10pt; width:10%">입니다.</td>
				  </tr>
			  </table>
			<div class="btn_wrap">
