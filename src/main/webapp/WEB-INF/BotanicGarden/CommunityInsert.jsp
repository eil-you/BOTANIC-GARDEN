		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-xs-4 text-right hidden-xs menu-2">
					<ul>
						<li><a href="viewLogin.do">LOGIN</a></li>
					</ul>
				</div>
			</div>
	...
	<form action="communityInsert.do">
		<table>
			<tbody>
				<tr>
					<td>
						<input type="text" class="writeTitle" placeholder="글제목" name="post_name" maxlength="50">
					</td>
				</tr>
				<tr>
					<td>
						<textarea class="writeContent" placeholder="글내용" name="post_contents" maxlength="2048" style="height: 350px;"></textarea>
						<input type="hidden" name="id" value="<%=vo.getId() %>">
					</td>
				</tr>
			</tbody>	
		</table>			
		<input type="submit" class="pull-right" id="wr_write" value="글쓰기">
	</form>
</div> <!--co_container E-->
</div> <!--wr_full-->
