		  ...
		  <div class="form_txtInput">
			...
			<form action="changePassword.do" method="post">
			  <table>
				...
				<tbody>
				  <tr>
					<th><span>변경할 비밀번호</span></th>
					<td><input type="password" class="pw" id="pw1" placeholder="변경할 비밀번호를 입력하세요."></td>
				  </tr>
				  <tr>
					  <th><span>변경할 비밀번호 확인</span></th>
					  <td><input type="password" name="password" class="pw" id="pw2" placeholder="변경할 비밀번호를 다시 입력하세요."><font id="checkPw" size="1"></font></td>
				  </tr>
				</tbody>
			  </table>
			<div class="btn_wrap">
